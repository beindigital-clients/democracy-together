...
export async function LibraryFacets({
  ...
  const groups: {
    ...
    { key: 'themes', legend: t('facetTheme'), ns: 'themes', items: facets.themes },
    { key: 'types', legend: t('facetType'), ns: 'types', items: facets.types },
    { key: 'regions', legend: t('facetRegion'), ns: 'regions', items: facets.regions },
    { key: 'langs', legend: t('facetLang'), ns: 'langs', items: facets.languages },
    { key: 'access', legend: t('facetAccess'), ns: 'access', items: facets.access },
  ];
            ...
            {g.items.map((opt) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="ml-auto font-mono text-[11px] text-muted">{opt.count}</span>
                </Link>
              );
            })}
          </div>
