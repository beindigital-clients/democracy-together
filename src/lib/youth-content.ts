...
const fr: YouthContent = {
  ...
  parcours: {
    ...
    steps: [
      { n: '1', title: 'Découvrir', body: 'Comprendre les enjeux avec des formats courts et accessibles.' },
      { n: '2', title: 'Apprendre', body: 'Boîte à outils, webinaires et modules de renforcement de capacités.' },
      { n: '3', title: 'Contribuer', body: 'Publier une tribune, rejoindre un groupe de travail, candidater à une bourse.' },
      { n: '4', title: 'Mentorer', body: 'Transmettre à ton tour, et accompagner un binôme du réseau.' },
    ],
    gam: {
  ...
  programmes: {
    ...
    featured: { kicker: 'Phare', title: 'Mentorat', body: "On t'associe à un mentor expérimenté du réseau, selon ta langue, ta région et tes thèmes. Six mois d'accompagnement, des objectifs clairs, un vrai suivi.", cta: 'Demander un mentor' },
    funding: { kicker: 'Financement', title: 'Bourses ciblées', body: 'Des bourses pour les jeunes chercheurs et les think tanks émergents, en priorité dans les régions fragiles.', cta: 'Voir les bourses' },
    items: [
      { kicker: 'Apprendre', title: 'Boîte à outils', body: 'Guides, modèles et modules courts pour monter en compétence, avec certification.', cta: 'Ouvrir la boîte' },
      { kicker: 'Publier', title: 'Tribunes', body: "Soumets une contribution courte, accompagnée d'un appui éditorial du réseau.", cta: 'Proposer une tribune' },
      { kicker: 'Agir', title: 'Campagnes', body: 'Rejoins des campagnes de sensibilisation et des événements jeunes à Dakar et Bruxelles.', cta: 'Voir les campagnes' },
    ],
  },
  mentor: {
    eyebrow: 'Mentorat',
    ...
    mentors: [
      { initials: 'AW', name: 'Aminata Wade', field: 'Gouvernance locale · Dakar', role: 'Mentore' },
      { initials: 'PV', name: 'Pieter Vandenberghe', field: 'Démocratie numérique · Bruxelles', role: 'Mentor' },
      { initials: 'LK', name: 'Linda Kouassi', field: 'Anti-corruption · Abidjan', role: 'Mentore' },
    ],
  },
  testimonial: {
    quote: "J'ai publié ma première tribune à 23 ans grâce au hub. Six mois plus tard, mon think tank m'a recrutée. Le réseau m'a ouvert des portes que je croyais fermées.",
...
const en: YouthContent = {
  ...
  parcours: {
    ...
    steps: [
      { n: '1', title: 'Discover', body: 'Understand the issues with short, accessible formats.' },
      { n: '2', title: 'Learn', body: 'Toolkit, webinars and capacity-building modules.' },
      { n: '3', title: 'Contribute', body: 'Publish an op-ed, join a working group, apply for a grant.' },
      { n: '4', title: 'Mentor', body: 'Pass it on in turn, and support a network pair.' },
    ],
    gam: {
  ...
  programmes: {
    ...
    featured: { kicker: 'Flagship', title: 'Mentoring', body: 'We pair you with an experienced mentor from the network, matched on your language, region and topics. Six months of support, clear goals, real follow-up.', cta: 'Request a mentor' },
    funding: { kicker: 'Funding', title: 'Targeted grants', body: 'Grants for young researchers and emerging think tanks, prioritising fragile regions.', cta: 'See the grants' },
    items: [
      { kicker: 'Learn', title: 'Toolkit', body: 'Guides, templates and short modules to build skills, with certification.', cta: 'Open the toolkit' },
      { kicker: 'Publish', title: 'Op-eds', body: 'Submit a short contribution, with editorial support from the network.', cta: 'Propose an op-ed' },
      { kicker: 'Act', title: 'Campaigns', body: 'Join awareness campaigns and youth events in Dakar and Brussels.', cta: 'See the campaigns' },
    ],
  },
  mentor: {
    eyebrow: 'Mentoring',
    ...
    cta: 'Find my mentor',
    mentors: [
      { initials: 'AW', name: 'Aminata Wade', field: 'Local governance · Dakar', role: 'Mentor' },
      { initials: 'PV', name: 'Pieter Vandenberghe', field: 'Digital democracy · Brussels', role: 'Mentor' },
      { initials: 'LK', name: 'Linda Kouassi', field: 'Anti-corruption · Abidjan', role: 'Mentor' },
    ],
  },
  testimonial: {
    quote: 'I published my first op-ed at 23 thanks to the hub. Six months later, my think tank recruited me. The network opened doors I thought were closed.',
    attrName: 'Fatou N., 24',
    attrPlace: 'Dakar',
